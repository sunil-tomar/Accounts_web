...
--
-- Host: localhost    Database: monthlyexpenses
-- ------------------------------------------------------
...
--
-- Table structure for table `test_business_unit`
--

DROP TABLE IF EXISTS `test_business_unit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `test_business_unit` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2023-05-13 19:06:23